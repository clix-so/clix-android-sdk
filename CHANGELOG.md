...
- **Push Notifications**
  - `ClixNotification` interface for setup and permission management
  - `autoOpenLandingOnTap` override to control landing URL behavior

### Fixed

- Duplicate push notification event tracking
